export const properties = [
  {
    id: 1,
    project: "Portfolio",
    brief: "My first project created to display my front-end abilities and to display my work.",
  ...
  },
  {
    id: 2,
    project: "GFit",
    brief: "A web application that allows users to track their fitness progress seamlessly.",
